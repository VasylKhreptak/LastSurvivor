...
namespace Zenject.Infrastructure.Toggleable
{
    public class ToggleableManager : IEnableable, IDisableable
    {
        ...
        public void Add(IEnableable enableable) => _enableables.Add(enableable);

        public void Add(IDisableable disableable) => _disableables.Add(disableable);

        public void Remove(IEnableable enableable) => _enableables.Remove(enableable);

        public void Remove(IDisableable disableable) => _disableables.Remove(disableable);
