...
namespace Main.Platforms.BuyZones
{
    public class BarracksBuyZoneInstaller : MonoInstaller
    {
        ...
        {
            _buyContainer = persistentDataService.Data.PlayerData.PlatformsData.BarracksPlatformData.BuyContainer;
        ...
        private void BindBinder() => Container.BindInterfacesTo<BarracksPlatform.BarracksPlatform>().AsSingle();
    }
}